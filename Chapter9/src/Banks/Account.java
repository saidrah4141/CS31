...
public class Account {
	 ...
	 */
	public Account(double bal, String fName, String lName, String str, String cit, String prov, String post)//include street, city, province or state, postal code or zip code
	 {
		balance = bal;
		cust = new Customer(fName, lName, str, cit, prov, post);//this constructor should reflect the new additions above, street, city, province, postal code
	...
	public void changeAddress(String str, String cit, String prov, String post) {
		cust.changeCity(cit);
		cust.changeStreet(str);
		cust.changePostalCode(post);
		cust.changeProvince(post);
	}
